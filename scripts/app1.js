...
var sessionurl = 'wss://node-vcqa.wiziq.com'+'/session/'+process.env.s;



var taste=function(id, displayName, fileName, callback)
{
	...
	if(fs.existsSync(__dirname+path.sep+'Data'+path.sep+fileName)) {
		...
		var ws=new WebSocket(sessionurl);
	}
	else {
...
taste('a','b',filename, function(a,ws,msg) {
...
console.log('following error occurs ');
console.log(msg);
