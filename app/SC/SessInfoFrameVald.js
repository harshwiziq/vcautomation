// This code is used for verifying full session info frame structure and validations
	...
	// this block is for info frames
			...
			if(Data.msg.info_id=="session-info"){
				...
				if(vtype) {
				 ...
				 if( Data.from !== 'controller') {
						return callback(0, ws, 'this frame is not coming from controller\n'+data);
					}
				 else {
