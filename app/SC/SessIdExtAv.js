// This code is used for verifying, session id should be same for every user in a particular session, in av-tokbox frame

// This code extracts the session id from av-tokbox-v2 frame and return it to the test case
			  ...
			  if(Data.msg.info.name=="av-tokbox-v2"){
				...
				//console.log(data);
                                ...
                                if(Data.msg.info.status !== 'ok') {
                                        return callback(0, null, ws, 'av-tokbox-v2 frame status is not-ok\n'+data);
                                }
                                if(! Data.msg.info.info.sessionid) {
                                        return callback(0, null, ws, "av-tokbox-v2 frame sessionid doesn't exist\n"+data);
                                }
                                else {
					//console.log(Data.msg.info.info.sessionid);
                                        return callback(1, Data.msg.info.info.sessionid, ws, null);
				}
                        }
